...
function showData(data) {
  ...
  data.forEach((prod) => {
    ...
    function myFunction() {
      ...
      if (
        document.documentElement.scrollTop < midContainer2.offsetTop &&
        document.documentElement.scrollTop >= top + midContainer1.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer3.offsetTop &&
        document.documentElement.scrollTop >= top + midContainer2.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer4.offsetTop &&
        document.documentElement.scrollTop >= top + midContainer3.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer5.offsetTop &&
        document.documentElement.scrollTop >= midContainer4.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer6.offsetTop &&
        document.documentElement.scrollTop > midContainer5.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer7.offsetTop &&
        document.documentElement.scrollTop >= top + midContainer6.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer8.offsetTop &&
        document.documentElement.scrollTop >= top + midContainer7.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer9.offsetTop &&
        document.documentElement.scrollTop >= midContainer8.offsetTop
      ) {
        //let P1=document.getElementById("p1")
        ...
        document.documentElement.scrollTop < midContainer10.offsetTop &&
        document.documentElement.scrollTop >= midContainer9.offsetTop
      ) {
        //let P1=document.getElementById("p1")
...
function cartData() {
  ...
  kart.forEach((item) => {
    ...
    buttonLeft.src =
      "https://github.com/pankaj5417/koovs.com/blob/main/icons/leftbtn.png?raw=true";

    let buttonRight = document.createElement("img");
    buttonRight.src =
      "https://github.com/pankaj5417/koovs.com/blob/main/icons/right btn.png?raw=true";
